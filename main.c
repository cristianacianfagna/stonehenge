...
int main( int argc, char *argv[]) {
	...
	if (argc<2){
		...
		ruotato=rotazione(2,3,territorio,-4,3, NORD);
		//ruotato=rotazione(6,7,territorio,9,-3, EST);
		//ruotato=rotazione(6,7,territorio,9,-3, OVEST);
		//ruotato=rotazione(6,7,territorio,9,-3, SUD);
